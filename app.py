...
app.config['JWT_SECRET_KEY'] = 'super_secret' #use it in future if you want to
...
def register():
    ...
    if test:
        return jsonify(message='This email id already exist')
    else:
        ...
        db.session.add(user)
        db.session.commit()
        return jsonify(message='User creation done successfully!!'), 201
...
def login():
    ...
    if test :
        ...
        return jsonify(message='either email or password is wrong'), 401
...
def update_planets():
    ...
    if planet:
        ...
        return jsonify(message='This planet id doesnt exist')
...
def delete_planet(planet_id:int):
    ...
    if planet:
        ...
        return jsonify(message='This planet id doesnt exist'), 404
